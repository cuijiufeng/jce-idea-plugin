...
/**
 * @author cuijiufeng
 * @Class KeyFactoryGenerateAction
 * @Date 2022/8/26 10:26
 */
public class KeyFactoryGenerateAction extends AnAction {
    @Override
    public void actionPerformed(@NotNull AnActionEvent event) {
        ...
        new AbstractGenerateCodeDialogWrapper(JceSpec.KeyFactory, event.getProject(), (PsiJavaFile) psiFile, event.getData(CommonDataKeys.EDITOR)){
        }.showAndGet();
    }
}
