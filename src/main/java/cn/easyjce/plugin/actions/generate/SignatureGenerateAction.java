...
/**
 * @author cuijiufeng
 * @Class SignatureGenerateAction
 * @Date 2022/8/26 10:35
 */
public class SignatureGenerateAction extends AnAction {
    @Override
    public void actionPerformed(@NotNull AnActionEvent event) {
        ...
        new AbstractGenerateCodeDialogWrapper(JceSpec.Signature, event.getProject(), (PsiJavaFile) psiFile, event.getData(CommonDataKeys.EDITOR)){
        }.showAndGet();
    }
}
