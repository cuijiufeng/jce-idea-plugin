...
/**
 * @author cuijiufeng
 * @Class CipherGenerateAction
 * @Date 2022/8/26 13:57
 */
public class CipherGenerateAction extends AnAction {
    @Override
    public void actionPerformed(@NotNull AnActionEvent event) {
        ...
        new AbstractGenerateCodeDialogWrapper(JceSpec.Cipher, event.getProject(), (PsiJavaFile) psiFile, event.getData(CommonDataKeys.EDITOR)){
        }.showAndGet();
    }
}
